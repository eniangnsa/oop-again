...
while True:
    ...
    # check for continous pressing
    key_pressed_tuple = pygame.key.get_pressed()
    
    if key_pressed_tuple[pygame.K_LEFT]: # move left
        ball_x -= N_PIXELS_TO_MOVE
        
    if key_pressed_tuple[pygame.K_RIGHT]: # move right
        ball_x += N_PIXELS_TO_MOVE
        
    if key_pressed_tuple[pygame.K_UP]: # move up
        ball_y -= N_PIXELS_TO_MOVE
    
    if key_pressed_tuple[pygame.K_DOWN]: # move down
        ball_y += N_PIXELS_TO_MOVE
